    ...
    <div class="container-xxl py-5">
            ...
            <div class="row container mb-4 m-auto">
                <div class="col-sm-8">
                    <div class="form-group">
                        ...
                        <input type="text" required value="{{$keyword}}" class="form-control" placeholder="Nhập tên bài viết" name="keyword">
                      </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                @endforeach
                @else
                    <div class="d-flex justify-content-center"><img src="https://svgur.com/i/AXk.svg" alt=""></div>
                @endif
